   ...
   <div class="sidebar__menu-group">
      <ul class="sidebar_nav">
         ...
         <li>
            ...
            <span class="badge badge-primary menuItem">1.2.0</span>
            </a>
         </li>
         ...
         <li class="has-child {{ request()->is('pages/table/*') ? 'open' : ''}}">
            ...
            <ul>
               ...
               <li>
                  <a href="{{ route('pages.table.ajaxDataTable') }}"
                     class="{{ Route::is('pages.table.ajaxDataTable') ? 'active': '' }}">Ajax Data Table</a>
               </li>
            </ul>
         </li>
