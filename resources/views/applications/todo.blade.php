                                        ...
                                        <td>
                                            <div class="checkbox-group d-flex">
                                                <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                    <input class="checkbox" type="checkbox" id="check-grp-td{{$key+1}}" {{ ($key+1==1 ||  $key+1==2 ? 'checked' : '') }}>
                                                    <label for="check-grp-td{{$key+1}}" class="fs-14 color-primary strikethrough">
                                                       {{ $todo->todo_text }}
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="todo-list__right">
                                                <ul class="d-flex align-content-center justify-content-end">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('applications.todo.delete', $todo->id) }}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="todo-list ptl--hover draggable" draggable="true">
                                            <td>
                                                <div class="checkbox-group d-flex">
                                                    <div class="checkbox-theme-default custom-checkbox checkbox-group__single d-flex">
                                                        <input class="checkbox" type="checkbox" id="check-grp-tds{{$key+1}}" {{ ($key+1==1 ||  $key+1==2 ? 'checked' : '') }}>
                                                        <label for="check-grp-tds{{$key+1}}" class="fs-14 color-primary strikethrough">
                                                           {{ $todo->todo_text }}
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                <div class="todo-list__right">
                                                    <ul class="d-flex align-content-center justify-content-end">
                                                        ...
                                                        <li>
                                                            <a href="#" class="{{ ($key+1==1 ||  $key+1==3 ? 'active' : '') }}">
                                                                <span data-feather="star"></span>
                                                            </a>
                                                        </li>
                                                        <li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="add-todo-form">
                            <form method="POST" action="{{ route('applications.todo.store') }}">
                                @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg @error('todo_text') is-invalid @enderror" name="todo_text" placeholder="Write your task" required>
                                    @error('todo_text')
