               ...
               <div class="card">
                  <div class="card-header">
                     <div class="changelog__title">
                        <span class="v-num">Version 1.2.0</span>
                        <span class="sign">-</span>
                        <span class="rl-date">Mar 23, 2021</span>
                     </div>
                     ...
                     <div class="version-list">
                        ...
                        <div class="version-list__single">
                           ...
                           <ul class="version-primary">
                              <li>Note Fully Functional</li>
                              <li>ToDo Fully Functional</li>
                           </ul>
                        </div>
                     </div>
                                 ...
                                 <div class="card-header w-100 px-sm-30 px-15" id="headingsix">
                                    <div role="button" class="w-100 changelog__accordingCollapsed collapsed" data-toggle="collapse" data-target="#collapsesix" aria-expanded="true" aria-controls="collapsesix">
                                       <div class="changelog__accordingTitle d-flex justify-content-between w-100">
                                          <div class="v-num">1.0.0<span class="v-arrow">-</span> <span class="rl-date">Feb 14,
                                             2021</span></div>
                     ...
                     <div class="changelog__according">
                        <div class="changelog__accordingWrapper">
                           <div id="accordion-one">
                              <div class="card">
                                 <div class="card-header w-100 px-sm-30 px-15" id="headingsix-one">
                                    <div role="button" class="w-100 changelog__accordingCollapsed collapsed" data-toggle="collapse" data-target="#collapsesix-one" aria-expanded="true" aria-controls="collapsesix">
                                       <div class="changelog__accordingTitle d-flex justify-content-between w-100">
                                          <div class="v-num">1.1.0<span class="v-arrow">-</span> <span class="rl-date">Jan 20, 2021</span></div>
                                          <div class="changelog__accordingArrow">
                                             <span data-feather="chevron-right"></span>
                                          </div>
                                       </div>
                                 ...
                                 <div id="collapsesix-one" class="collapse" aria-labelledby="headingsix-one" data-parent="#accordion-one">
                                    <div class="card-body">
                                       <div class="version-list">
                                          <div class="version-list__single">
                                             <ul class="version-success">
               ...
               <div class="card">
                  ...
                  <div class="card-body p-25">
                     ...
                     <ul class="v-history-list">
                        <li><span class="version-name">Version 1.2.0</span><span class="version-date">Mar 23,
                           2021</span>
                        </li>
                        <li><span class="version-name">Version 1.1.0</span><span class="version-date">Feb 14,
                           2021</span>
                        </li>
