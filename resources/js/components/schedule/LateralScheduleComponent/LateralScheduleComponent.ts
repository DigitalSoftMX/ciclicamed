...
export default defineComponent({
    ...
    */
     ...
     * @property {string} finishTime Al actualiar la hora de finalización se actualiza la {@link LateralScheduleComponent.updateScheduleTimes|fecha y hora de finalización de la cita}
     ...
     * a su copia (doctorsList), además verifica si el ID de la sucursal de la consulta (schedule.branch_id) es igual que la copia de la consulta (scheduleSelectedCopy.branch_id): en
     ...
     * se obtiene la lista de {@link LateralScheduleComponent.getTestList|estudios médicos}, además que se asigna a la variable scheduleSelectedCopy.medicalconsultcategory_id
     * el tipo de consulta médica a la que pertenece la consulta
     ...
     * la especialidad médica a la que pertenece (scheduleSelectedCopy.medicalspecialty_id)
    */
    watch:
    {
        startTime()
