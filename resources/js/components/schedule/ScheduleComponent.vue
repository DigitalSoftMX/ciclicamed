<template>
    <div class="row mx-0">
        <div class="col-12 col-md-4 col-xl-3">
            <schedule-select-component :branchesList="branchesList" :doctorList="doctorList"
                @onDoctorSelected="getScheduleList" @onBranchSelected="getDoctorList"
                @onUserSchedule="selectUserSchedule" :employeeBranches="employeeBranches"
                @onEmployeeScheduleSelect="getScheduleBranchList" @onEmployeeAllSchedule="getDoctorScheduleList" :role="role"></schedule-select-component>
        </div>
    ...
    <schedule-action-component :schedule="scheduleSelected" :employeeID="employeeID" :role="role"></schedule-action-component>
    ...
    <lateral-schedule-component ref="openLateralSchedule" :schedule="scheduleSelected" :branchesList="branchesList"
        :doctorsList="doctorList" :businessHours="businessHours" :patientsList="patientsList" :patientID="userID" :role="role"></lateral-schedule-component>
