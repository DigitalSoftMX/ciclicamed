                            ...
                            <div class="card shadow-none">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-25 row mx-0">
                                        ...
                                        <el-time-select class="col-12 p-0 w-100" start="07:00" step='00:15' end="21:00"
                                            v-model="hours[index].start_time" placeholder="Hora inicial">
                                        </el-time-select>
                                    </div>
                                    <div class="row mx-0">
                                        <label class="col-12 p-0">Hora final</label>
                                        <el-time-select class="col-12 p-0 w-100" start="07:00" step='00:15' end="21:00" :minTime="hours[index].start_time"
