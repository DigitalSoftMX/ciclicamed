        ...
        <div class="card card-default card-md bg-normal card-bordered">
            <div class="card-header">
                ...
                <div class="custom-control custom-switch switch-primary switch-md ">
                    <input type="checkbox" class="custom-control-input" id="otrosCheck" checked="">
            ...
            <div class="card-body">
                <div class="w-auto">
                    <div class="with-icon">
                        ...
                        <textarea type="text" class="form-control" id="otrosDescription" placeholder="Otros"></textarea>
                    </div>
                </div>
            </div>
        </div>
