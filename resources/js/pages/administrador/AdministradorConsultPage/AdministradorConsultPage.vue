<template>
    <div v-if="specialty === 11 || specialty == 12">
        <nurse-consult-page :nurse="doctor" :consult="consult"></nurse-consult-page>
    </div>
    <div v-else>
...
<script lang="ts" src="./AdministradorConsultPage.ts"></script>
