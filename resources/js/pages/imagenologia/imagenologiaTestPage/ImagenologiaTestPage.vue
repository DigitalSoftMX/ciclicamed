<template>
    <navbar-component @menuSelect="changeSidebarStatus" title="Subir resultados" :userData="imagenologia" role="Imagenología"
        :photo="imagenologia.photo"></navbar-component>
