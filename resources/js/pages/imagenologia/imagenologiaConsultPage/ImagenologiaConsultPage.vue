<template>
    <navbar-component @menuSelect="changeSidebarStatus" title="Perfil de usuario" :userData="nurse" role="Imagenología"
...
<script lang="ts" src="./ImagenologiaConsultPage.ts"></script>
