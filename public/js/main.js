...
(function($) {
    ...
    //         adaptiveHeight: getData(
    //             $(this).data("adaptiveHeight-slick"),
    //             false
    //         ),
    ...
    //     $(this)
    //         .find(".follow-icon")
    //         .toggleClass("la-user-plus");
    //     $(this)
    //         .find(".follow-icon")
    //         .toggleClass("la-user-check");
    //     $(this).toggleClass("active");
    // });
    ...
    //     document.querySelector(".mCSB_container").style.top =
    //         activeLinkOffset + "px";
    // }
    ...
    //                     var myFromField = myDateRangeTarget.attr(
    //                         "data-from-field"
    //                     );
