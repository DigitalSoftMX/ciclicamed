...
//             Route::get('/ajax-data-table', [PageController::class, 'ajaxDataTable'])->name('pages.table.ajaxDataTable');
//         });
...
//         Route::get('note/{label}', [ChatController::class, 'noteLabel'])->name('applications.noteLabel');
//         Route::post('note', [ChatController::class, 'store'])->name('applications.note.store');
//         Route::get('note/favorite/{id}', [ChatController::class, 'favorite'])->name('applications.note.favorite');
//         Route::get('note/destroy/{id}', [ChatController::class, 'destroy'])->name('applications.note.destroy');
...
//         Route::post('todo', [ToDoController::class, 'store'])->name('applications.todo.store');
//         Route::get('/delete/{id}', [ToDoController::class, 'destroy'])->name('applications.todo.delete');
